					       ...
					       void *user, void *in, size_t len)
{
	...
	unsigned char buf[LWS_SEND_BUFFER_PRE_PADDING + MAX_CONTENT_LENGHT +
	...
	case LWS_CALLBACK_RECEIVE:
		...
		if(strcmp("INIT",incoming_str)==0)
		{
			...
			//libwebsocket_write(wsi, &buf[LWS_SEND_BUFFER_PRE_PADDING], MAX_CONTENT_LENGHT, LWS_WRITE_TEXT);
		}
		else
			printf("NO!");
