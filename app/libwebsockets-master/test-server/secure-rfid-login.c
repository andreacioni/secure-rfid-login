					       ...
					       void *user, void *in, size_t len)
{
	...
	case LWS_CALLBACK_RECEIVE:
		...
		username[LWS_SEND_BUFFER_PRE_PADDING] = 'A';
		username[LWS_SEND_BUFFER_PRE_PADDING+1] = 'n';
		username[LWS_SEND_BUFFER_PRE_PADDING+2] = 'd';
		username[LWS_SEND_BUFFER_PRE_PADDING+3] = 'r';

		password[LWS_SEND_BUFFER_PRE_PADDING] = 'p';
		password[LWS_SEND_BUFFER_PRE_PADDING+1] = 's';
		password[LWS_SEND_BUFFER_PRE_PADDING+2] = 'w';
